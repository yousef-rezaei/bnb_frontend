...
const ReservationSidebar:React.FC<ReservationSidebarProps> = ({
    ...
    const guestsRange = Array.from({ length: property.guests},(__,index) => index + 1);
    ...
    return (
        ...
        <select
         ...
         >
            {guestsRange.map((guest) => (
                <option key={guest} value={guest}>{guest}
                </option>
            ))}
        </select>
       </div>
       <div
            ...
            className="w-full mb-6 text-center text-white bg-airbnb hover:bg-airbnb-dark rounded-xl"
        >
            Book
        </div>
